...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "xrm87uacxhq8t07hy63kxta5k5a9pf1ca3am2wafrvxp9c2c5hhh",
  ...
  manifest = (
    ...
    appMarketingVersion = (defaultText = "2.19.1"),
    ...
    metadata = (
      ...
      icons = (
        ...
        appGrid = (svg = embed "monica.svg"),
        grain = (svg = embed "monica.svg"),
        market = (svg = embed "monica.svg"),
        marketBig = (svg = embed "monica.svg"),
      ),

      website = "https://www.monicahq.com/",
      # This should be the app's main website url.

      codeUrl = "https://github.com/rs22/monica-sandstorm",
      ...
      shortDescription = (defaultText = "Contact Manager"),
  ...
  alwaysInclude = ["opt/www/html", "usr/local/lib/php/extensions"],
